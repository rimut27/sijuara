...
import Rekomendasi from './Rekomendasipelatihan';
...
function Rincian() {
    ...
    const [showRekomendasijobModal, setShowRekomendasiModal] = useState(false);
    const handleRekomendasiModalClose = () => setShowRekomendasiModal(false);
    const handleRekomendasiModalShow = () => setShowRekomendasiModal(true);
    ...
    return (
        <Container>
            ...
            <Row >
                ...
                <Col>
                    <Button style={{ width: '10rem', height: "3rem" }} onClick={handleormtranerModalShow} variant='success'>
                        Edit Pelatihan
                    </Button>
                    <br />
                    <br />
                    <Button variant="success" style={{ width: '10rem', height: "3rem" }} onClick={handleConfirm} >
                        Hapus
                    </Button>
                    ...
                    <br />
                    <br />
                    <Button style={{ width: '10rem', height: "3rem" }} onClick={handleRekomendasiModalShow} variant='success'>
                        Rekomendasikan
                    </Button>
                    <Rekomendasi show={showRekomendasijobModal} handleClose={handleRekomendasiModalClose} />
