  ...
  return (
    <div className="App mt-3">
      <Container variant="outline-secondary">
        <h1>   <Button variant="secondary" onClick={handleGoBack}>&#129056;</Button> Semua Dokumen </h1>
        <Row className="mt-5">      
          <Col
            sm={5}
            bg="light"
          ...
          <Button style={{ width: '10rem', height: "3rem" }} onClick={handleBuatDokumenodalShow} variant='success'>
            Buat Dokuemen
          </Button>
          <BuatDokumen show={showBuatDokumenModal} handleClose={handlePBuatDokumenModalClose} />
        </Row>
      </Container>
    </div>
  );
